            ...
            if len(vals) != 1:
                ...
                if flag:
                    ...
                    for team in other_teams:
                        ...
                        logger.error(f"{name} submitted the flag but it was generated by {generated_by_name}. Banning...")
                        if ctfd.ban_team(team):
                            logger.info(f"Successfully banned team {name}")
                        else:
                            logger.error(f"An error occurred when banning team {name}")
                ...
                if db_flag:
                    ...
                    if int(generated_by) != int(team_id):
                        ...
                        for team in teams:
                            ...
                            if name != generated_by_name:
                                msg['ban'].append(f"**{name}** has been ***BANNED*** for submitting **{generated_by_name}**'s flag of challenge ***{chal_name}***.")
                        msg['msg'].append(f"Team **__{generated_by_name}__**'s flag of challenge **__{chal_name}__** was also used by **__{name}__**, both teams have been banned.")
                        # Get submission id:
                        submission_id = vals[0]['submission_id']
                        logger.info(f"Deleting submission {submission_id}...")
                        if ctfd.delete_submission(submission_id):
